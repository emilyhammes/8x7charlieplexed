/*
  Modified from the original LOLshiled version by Emily Hammes for use with 8x7shield
...
#include "Charliplexing8x7invert.h"
...
#endif
// changed ledMap to have the correct numbers for 8x7 shield (not LOL shield) 
// numbers assume you plug the shield into pins 2-9 
const LEDPosition PROGMEM ledMap[56] = {
    L(8, 9), L(9, 8), L(7, 9), L(9, 7), L(3, 9), L(9, 3), L(5, 9), L(9, 5),
	L(7, 8), L(8, 7),L(6, 8), L(8, 6),  L(6, 9), L(9, 6), L(4, 8), L(8, 4), 
    L(6, 7), L(7, 6), L(5, 7), L(7, 5), L(5, 8), L(8, 5), L(4, 9), L(9, 4), 
    L(5, 6), L(6, 5), L(2, 9), L(9, 2), L(4, 7), L(7, 4), L(3, 8), L(8, 3), 
    L(4, 5), L(5, 4), L(4, 6), L(6, 4), L(3, 6), L(6, 3), L(2, 7), L(7, 2), 
    L(3, 4), L(4, 3), L(3, 5), L(5, 3), L(2, 5), L(5, 2), L(3, 7), L(7, 3), 
    L(2, 3), L(3, 2), L(2, 4), L(4, 2), L(2, 8), L(8, 2), L(2, 6), L(6, 2), 
};
#undef P(pin)
#undef L(high, low)
