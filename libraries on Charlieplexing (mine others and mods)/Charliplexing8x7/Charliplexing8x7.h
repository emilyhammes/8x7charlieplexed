/*
  ...
  Edited by Emily Hammes, February 13, 2017 for use with 8x7 board
...
#define DISPLAY_COLS 8     // Number of columns in the display
...
namespace LedSign
{
    ...
    extern void Set(uint8_t x, uint8_t y, uint8_t c = 1)  __attribute__((noinline));
