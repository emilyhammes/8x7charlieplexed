...
#include <Charliplexing8x7.h>    //Imports the library, which needs to be
                              //Initialized in setup.

#define DELAY 250             //Sets the time each generation is shown
...
const int density = 20;       //Sets density % during seeding
